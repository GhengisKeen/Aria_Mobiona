...
public class CalibrationBleService implements CasGattListener{
    ...
    */
    ...
    public final static int STATUS_CALIBRATION = 1;
    public final static int STATUS_EXECUTION = 2;
    ...
    public void startCalibration(){
        ...
        writeCalibrationMode(CalibrationBleService.STATUS_CALIBRATION);

    }//startCalibration

    public void startExecution(){
        writeCalibrationMode(CalibrationBleService.STATUS_EXECUTION);

    }

    public void startSleep(){
        writeCalibrationMode(CalibrationBleService.STATUS_SLEEP);
