...
public class AriaBleService implements ArsGattListener{
    ...
    public final static int GESTURE_ENTER   = 1; //right    - 0x4F - 79
    public final static int GESTURE_HOME    = 2; //down     - 0x51 - 81
    public final static int GESTURE_UP      = 3; //up       - 0x52 - 82
    public final static int GESTURE_DOWN    = 4; //left     - 0x50 - 80
    public final static int GESTURE_BACK    = 5; //enter    - 0x28 - 40
